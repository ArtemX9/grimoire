          ...
          <CardContent>
            <form onSubmit={handleSignIn} className='flex flex-col gap-3'>
              <div className='flex flex-col gap-1.5'>
                <label htmlFor='login-email' className='font-sans text-xs text-grimoire-muted'>Email</label>
                <Input
                  id='login-email'
                  type='email'
              ...
              <div className='flex flex-col gap-1.5'>
                <label htmlFor='login-password' className='font-sans text-xs text-grimoire-muted'>Password</label>
                <Input
                  id='login-password'
                  type='password'
                  placeholder='••••••••'
